...
def main():
    ...
    parser.add_argument('--user_id', required=True, help='User ID (e.g., email or uuid)')
    parser.add_argument('--name', required=True, help='Key name (e.g., "Development Key")')
    parser.add_argument('--tier', default='free', choices=['free', 'starter', 'professional', 'enterprise'], help='Subscription tier')
